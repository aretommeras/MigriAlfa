...
simulator loading of source histories. (.mirt files). These files were before stored in the
/migri path of the project, while they now will / should be stored in the /db path.
